...
public class CollectActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkedData();
        registerForContextMenu(rank_listView);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        current = ((AdapterView.AdapterContextMenuInfo)menuInfo).position;
    }
...
//                cartoon = new Cartoon(id, name, icon, author, theme, ranking, state, introduction);
            ...
            Toast.makeText(CollectActivity.this, "暂时没有收藏", Toast.LENGTH_SHORT).show();
        }
    ...
    private void initListView() {
        rank_listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                intent = new Intent(CollectActivity.this, CartoonActivity.class);
